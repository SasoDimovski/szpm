...
namespace Modules\Associations\Providers;
...
class AssociationsServiceProvider extends ServiceProvider
{
    ...
    protected string $name = 'Associations';

    protected string $nameLower = 'associations';
    ...
    public function boot(): void
    {
        ...
        $this->loadViewsFrom(module_path($this->name, 'resources/views'), 'Associations');
    }

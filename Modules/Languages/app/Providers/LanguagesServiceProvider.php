...
class LanguagesServiceProvider extends ServiceProvider
{
    ...
    protected string $nameLower = 'languages';
    ...
    public function boot(): void
    {
        ...
        $this->mergeConfigFrom(__DIR__ . '/../../config/config.php', 'languages');
        $this->loadViewsFrom(module_path($this->name, 'resources/views'), 'Languages');
    }

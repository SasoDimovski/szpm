...
class RecordsServiceProvider extends ServiceProvider
{
    ...
    protected string $name = 'Records';

    protected string $nameLower = 'records';
    ...
    public function boot(): void
    {
        ...
        $this->mergeConfigFrom(__DIR__ . '/../../config/config.php', 'records');
        $this->loadViewsFrom(module_path($this->name, 'resources/views'), 'Records');
    }

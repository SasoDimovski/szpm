...
Солидарност-Аеродром</strong></div> </td>
  ...
  <tr>
    ...
    <td width="980"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td class="naslov">&nbsp;</td>
        <td align="center" class="naslov"><!-- InstanceBeginEditable name="naslov" -->Контакт<!-- InstanceEndEditable --></td>
        <td class="naslov">&nbsp;</td>
      </tr>
      <tr>
...
%>
        ...
        <td valign="top" class="kelija_sodrzina"><!-- InstanceBeginEditable name="sodrzina" -->
          <h2>Здружение  на пензионерите ,,Солидарност-Аеродром&rdquo;- Скопје</h2>
          <p>            Ул.Ангел  Димовски бр.4 Скопје<br />
            тел.02/2461-446<br />
            e-mail:<u><a href="mailto:solidarnostaerodrom@yahoo.com">solidarnostaerodrom@yahoo.com</a></u></p>
<h3></h3>

...
%>
        ...
        <td valign="top" class="kelija_sodrzina"><!-- InstanceBeginEditable name="sodrzina" -->
          <h2>Здружение  на пензионери Битола</h2>
          <p> ,,Булевар 1 ви мај“ 268, 7000 Битола<br />
            <br />
            Контакт: <a href="mailto:zdr_penzionribt@t-home.mk">zdr_penzionribt@t-home.mk</a></p>
          <p>Teлефони : 047 236 036; 047 202 399 ; 071 213 585;</p>
<h3>&nbsp;</h3>

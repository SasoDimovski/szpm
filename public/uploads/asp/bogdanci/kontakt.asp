...
%>
        ...
        <td valign="top" class="kelija_sodrzina"><!-- InstanceBeginEditable name="sodrzina" -->          
          <h2>ОПШТИНСКО ЗДРУЖЕНИЕ НА ПЕНЗИОНЕРИ - БОГДАНЦИ</h2>
          <p>ул. Маршал Тито  бр.111 БОГДАНЦИ<br />
            e-mail: <a href="mailto:ozp.bogdanci@gmail.com">ozp.bogdanci@gmail.com</a></p>
          <p>тел. 034 221 113</p>

...
%>
        ...
        <td valign="top" class="kelija_sodrzina"><!-- InstanceBeginEditable name="sodrzina" -->
          <h3>Здружение на пензионери &bdquo;ЧАИР&ldquo; - Скопје</h3>
          <p>ул.&bdquo;Џон Кенеди&ldquo; бр.18  Скопје</p>
          <p>тел.:02 2 638-291</p>
          <p>моб. 071 333-266&nbsp;&nbsp;&nbsp; </p>
Е-маил : zpchair@gmail.com        <!-- InstanceEndEditable --></td>

    ...
    <td width="50%">Надзорен одбор</td>
          ...
          <table width="100%" class="dijagram">
            ...
            <tr>
              ...
              <td>Комисија за одмор и екскурзии</td>
            </tr>
            <tr>
              <td>Статутарна комисија</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="bez_padding">
  <tr>
    <td width="32%" align="center"><img src="Ibraim-osmani---pretsed.-na-Sobranie.jpg" width="110" height="155" /></td>
    <td align="center">&nbsp;</td>
    <td width="32%" align="center"><img src="Rauf-Hamidi-pretseda.-na-IO-i-na-ZP.jpg" alt="" width="110" height="155" /></td>
    <td align="center">&nbsp;</td>
    <td align="center"><img src="Ivanka-Seckova-sekretar_.jpg" alt="" width="110" height="155" /></td>
    </tr>
  <tr>
    <td align="center" valign="top">Ибраим Османи, <br />
      претседател на Собрание</td>
    <td align="center" valign="top">&nbsp;</td>
    <td valign="top">Рауф Хамиди, претседател на ЗП и ИО</td>
    <td align="center" valign="top">&nbsp;</td>
    <td valign="top">Иванка  Сечковска,<br />
      секретар</td>
    </tr>
</table>
          <h3>СОБРАНИЕ</h3>
<table width="100%" border="0">
  <tr>
              <td width="50%" valign="top"><ol>
                  <li>Ибраим  Османи (претседател)</li>
                    <li>Рауф  Хамиди</li>
                    <li>Тодор  Илиев</li>
                    <li>Нурије  Кадрију</li>
                    <li>Иванка  Сечковска</li>
                    <li>Љубица  Лолевска</li>
                    <li>Михаил  Мишев</li>
                    <li>Луан  Саити</li>
              </ol></td>
              <td valign="top"><ol start="9">
                  <li>Рашид  Идризи</li>
                    <li>Муса  Лиман</li>
                    <li>Слободан  Величков</li>
                    <li>Александар  Урдаревски</li>
                    <li>Али  Дилавер</li>
                    <li>Ремзи  Реџеп</li>
                    <li>Исуф  Чајани</li>
                    <li>Реџеп  Ајети</li>
          ...
          <table width="100%" border="0">
            <tr>
              <td width="50%" valign="top"><ol>
                  <li>Рауф  Хамиди (претседател)</li>
                    <li>Љубица  Лолевска</li>
                    <li>Бељул  Сулејмани</li>
                    <li>Луан  Саити</li>
              </ol></td>
          ...
          <ol>
            <li>Виолета  Шишкова (претседател)</li>
            <li>Маре  Ѓелевска</li>
            <li>Саким  Ламаџема</li>
          </ol>
          <h3>СТАТУТАРНА КОМИСИЈА</h3>
            <ol>
                <li>Александар  Урдаревски (претседател)</li>
                <li>Иванка  Сечковска</li>
                <li>Реџеп  Ајети</li>
            </ol>
          <h3>КОМИСИЈА ЗА СПОРТ И РЕКРЕАЦИЈА</h3>
            <ol>
                <li>Реџеп  Ремзи (претседател)</li>
                <li>Рашид  Идризи</li>
                <li>Дилавер  Али</li>
            </ol>
          <h3>КОМИСИЈА ЗА КУЛТУРНО-ЗАБАВЕН ЖИВОТ</h3>
            <ol>
                <li>Бељул  Сулејмани (претседател)</li>
                <li>Љубица  Лолевска</li>
                <li>Фари  Груби</li>
            </ol>
          <h3>КОМИСИЈА ЗА ЗДРАВСТВО, ЗДРАВСТВЕНА ЗАШТИТА И  СОЦИЈАЛНИ ПРАШАЊА</h3>
            <ol>
                <li>Агрон  Рамадани (претседател)</li>
                <li>Слободан  Величков</li>
                <li>Томислав  Јандревски</li>
            </ol>
          <h3>КОМИСИЈА ЗА ОДМОР И ЕКСКУРЗИИ</h3>
            <ol>
                <li>Иванка  Сечковска (претседател)</li>
                <li>Исуф  Чајани</li>
                <li>Луан  Саити</li>
            </ol>
          <h3>АКТИВ НА ПЕНЗИОНЕРКИ              </h3>
            <p>1. Љубица Лолевска (претседател)<br />
                2. Иванка Сечковска</p>
          <h3>&nbsp;</h3>

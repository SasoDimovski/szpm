...
<div class="meni">
  ...
  <tr>
    ...
    <td width="980"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td class="naslov">&nbsp;</td>
        <td align="center" class="naslov"><!-- InstanceBeginEditable name="naslov" --><strong>Контакт</strong><!-- InstanceEndEditable --></td>
        <td class="naslov">&nbsp;</td>
      </tr>
      <tr>
...
%>
        ...
        <td valign="top" class="kelija_sodrzina"><!-- InstanceBeginEditable name="sodrzina" -->          
          <h2>Здружение на пензионери Демир Хисар</h2>
          <p>ул. &bdquo;Маршал  Тито&ldquo; бб<br />
            Демир Хисар<br />
            Тел.: + 389 047 276 951<br />
            Е-маил:<br />
            Zoranstevanovski1@gmail.com<br />
            Број на членови  - 1690<br />
            Број  на ограноци - 17 </p>

...
%>
        ...
        <td valign="top" class="kelija_sodrzina"><!-- InstanceBeginEditable name="sodrzina" -->
          <p>Здружението на пензионери Ѓорче  Петров е правен субјект, формирано е 2001 година со околу 5 000 членови - пензионери. </p>
          <p>          Зголемена  активност започнува во 2006 година кога се формираат разграноци и се заокружува  организационата и Статурарната поставеност.</p>
          <p>          Здружението  активно и успешно реализира свои  програмски активности и се вклучува  во сите  активности организирани од СЗПМ. ЗП Ѓорче Петров учествува во регионални и  републички рeвии на песни, музика и  игри, спортски настапи, екскурзии, хуманитарни акции, соработува со Црвениот  Крст и други инстируции.Здружението е збратимено со ЗП Битола и со други  пензионерски здруженија. Соработува одлично со локалната самоуправа и учествува  во сите акции што ги организира Општината      Активностите  се одвиваат преку Комисиијата  за Статут  и правни прашања, Комисијата за здравство, Комисијата за материјално финансиско  работење  и набавки,  Комисијата за спорт и рекреација, Комисијата  за култура и Активот на пензионерки. Сите овие активности истовремено се контролирани  од Надзорниот одбор, кој го контролира финансиското работење на здружението.</p>
          <p>          Во  изминатиот период Здружението ги регистрираше сите поважни настани и случувања  и ги забележа во трите издадени монографски изданија, издадени  за 10, 15 и 20 години, што го вбројува меѓу  најдобрите и единствени на оваа поле во рамките на СЗПМ.</p>
          <p>          Денес  Здружението брои повеќе од 8.000 членови кои своите активности ги реализираат  преку раководството во 7-те разграноци во своите пензионерски клубови како и  заедничкиот клуб на пензионерите. </p>

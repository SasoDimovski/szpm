...
%>
        ...
        <td valign="top" class="kelija_sodrzina"><!-- InstanceBeginEditable name="sodrzina" -->
          <h3>Здружение на пензионерите на Ѓорче Петров</h3>
          <p>            ул. Ѓорче Петров бр. 12-а Ѓорче Петров, 
            Скопје <br />
            Телефон  2036 030<br />
            E-mail:  <a href="mailto:zpgpetrov@hotmail.com">zpgpetrov@hotmail.com</a></p>

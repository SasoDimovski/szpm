    ...
    <td width="50%">Надзорен одбор</td>
          ...
          <table width="100%" class="dijagram">
            <tr>
              ...
              <td width="50%">Комисија  за награди и парична помош</td>
              </tr>
            <tr>
              <td>Комисија  за огревно дрво и помош во артикли</td>
              <td>Комисија  за забава и култура</td>
            </tr>
          </table>
          <br />
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="bez_padding">
            <tr>
              <td width="32%" align="center"><img src="Blagoje-Atanasovski-pretsedatel-na-IO.jpg" alt="" width="110" height="155" /></td>
              <td width="1%" align="center">&nbsp;</td>
              <td width="32%" align="center"><img src="Vase-Gorgievski--pretsedatel-na-sobranie.jpg" alt="" width="110" height="155" /></td>
              <td width="1%" align="center">&nbsp;</td>
              <td width="32%" align="center"><img src="Vinko-Angelovski-pretsedatel-na-nadzoren-odbor.jpg" alt="" width="110" height="155" /></td>
              </tr>
            <tr>
              <td align="center" valign="top">БЛАГОЈА АТАНАСОВСКИ, <br />
                Претседател на  собрание&nbsp;&nbsp;</td>
              <td align="center" valign="top">&nbsp;</td>
              <td align="center" valign="top">ВАСЕ ЃОРЃИЕВСКИ, <br />
                Претседател  на ИО </td>
              <td align="center" valign="top">&nbsp;</td>
              <td align="center" valign="top">ВИНКО АНГЕЛОВСКИ, <br />
                Претседател  на НО </td>
              </tr>
            <tr>
              <td align="center" valign="top">&nbsp;</td>
              <td align="center" valign="top">&nbsp;</td>
            ...
            <tr>
              <td align="center">&nbsp;</td>
              <td align="center" valign="top">&nbsp;</td>
              <td align="center"><img src="Cane-Antovski-delegat-vo-SZPM.jpg" alt="" width="110" height="155" /></td>
              <td align="center">&nbsp;</td>
              <td align="center">&nbsp;</td>
              </tr>
            <tr>
              <td align="center" valign="top">&nbsp;</td>
              <td align="center" valign="top">&nbsp;</td>
              <td align="center" valign="top">ЦАНЕ АНТОВСКИ, <br />
                Делегат во СЗП на град Скопје</td>
              <td align="center" valign="top">&nbsp;</td>
              <td align="center" valign="top">&nbsp;</td>
              </tr>
      </table>
...
-->            <strong><em>Собрание на Здружението</em></strong></p>
          <h3>СОБРАНИЕ</h3>
          <ol>
            <li>Благоје  Атанасовски претседател на собрание </li>
            <li>Киро  Митревски </li>
            <li>Јовица  Стојановски </li>
            <li>Павле  Ацевски </li>
            <li>Зоран  Крстевски </li>
            <li>Љупче Ивановски </li>
            <li>Блаже  Станисавовски </li>
            <li>Цветан  Велковски </li>
            <li>Цане  Антовски </li>
            <li>Стојан  Арсовски </li>
            <li>Томе  Павловски&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
          </ol>
<!--          <p align="center"><img src="izvrsen-odbor-pri-ZP-Solidarni-penzioneri.jpg" alt="" width="520" height="390" /><br />
  <strong><em>Извршен одбор</em></strong></p>-->
          <h3><strong>ИЗВРШЕН ОДБОР</strong></h3>
          <ol>
              <li>Васе  Ѓорѓиевски претседател </li>
              <li>Трајче  Христовски потпретседател </li>
              <li>Нада  Стојанова член </li>
              <li>Владо  Гелевски член </li>
              <li>Станимир  Марковски член          </li>
              </ol>
          <h3>НАДЗОРЕН ОДБОР</h3>
            <ol>
                <li>Винко  Ангеловски претседател </li>
                <li>Стојанче  Николовски член </li>
                <li>Кирил  Тодоровски член          </li>
            </ol>
            <h3><strong>Делегат во СЗПМ</strong></h3>
            <ol>
                <li>Цане  Антовски </li>
            </ol>
            <p><strong>Секретар</strong> - Славка Трајковска </p>
<h3>&nbsp;</h3>
          <h3>&nbsp;</h3>

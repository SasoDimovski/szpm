...
%>
        ...
        <td valign="top" class="kelija_sodrzina"><!-- InstanceBeginEditable name="sodrzina" -->
          <p>Здружението  на пензионери Карпош е формирано на 5 јануари 1978 година и е едно од најстарите  здруженија во Република Македонија. Во тоа далечно време брои&nbsp; 18445 членови. Како одминуваат годините  здружението има и убави и тешки години. Заради одредени случувања здружението повеќе пати се регистрирало и  пререгистрилало (12 пати) барајќи  правда низ повеќе институции и на повеќе нивои. Исходот бил позитивен бидејќи  правдата секогаш доаѓа и упорноста на оние кои ја бараат се наградува. Така е и  со оваа здружение. </p>
<h3>Здружение  на пензионери Карпош </h3>
          <p> Основано:  05.01.1978 година<br />
            ЕМБС  &ndash; 4103513<br />
            Ул.  Багдадска бр. 7. Општина Карпош &ndash; Скопје<br />
            Телефон:  +389 2 2039-743<br />
            Е-mail: <a href="mailto:zpkarpos@gmail.com">zpkarpos@gmail.com</a></p>
          
          <p>              Ограноци:</p>
          <ul>
            <li> Козле</li>
            <li>Влае  (Злокуќани, Бардовци)</li>
            <li> Нерези</li>
            <li> Козле</li>
            <li> Карпош  1 и 2</li>
            <li> Карпош  3 и 4</li>
            <li> Тафталиџе  1 и 2</li>
          </ul>

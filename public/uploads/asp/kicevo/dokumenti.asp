...
%>
        ...
        <td valign="top" class="kelija_sodrzina"><!-- InstanceBeginEditable name="sodrzina" -->
          <ul>
            <li>Статут на здружението  на пензионери Кичево<br />
              Донесен на ден  30.03.1917 година</li>
            <li>Правилник за  работа и работни места во <br />
              Здружението</li>
            <li> Решение од  Собрание на општина Кичево за сопственост на зградата на домот на пензионери  Кичево.</li>
          </ul>

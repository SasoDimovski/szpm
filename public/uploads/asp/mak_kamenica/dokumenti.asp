...
%>
        ...
        <td valign="top" class="kelija_sodrzina"><!-- InstanceBeginEditable name="sodrzina" -->
            <ul>
                <li><a href="izvestaj 2024.pdf" target="_blank">Изветај за работа на органите и телата на здружението на пензионерите на Македонска Каменица за
период од 01.01-31.12.2024 година</a></li>
            </ul>

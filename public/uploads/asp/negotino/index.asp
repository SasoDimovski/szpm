...
%>
        ...
        <td valign="top" class="kelija_sodrzina"><!-- InstanceBeginEditable name="sodrzina" -->
          <p>Здружението на пензионерите - Неготино формирано е  во далечната 1954 година. Тоа било &nbsp;првата  пензионерска организација во регионот, а основачи биле: Пано Малиминов - претседател,  Атанас Иванов - секретар и Васил Тефов - благајник. Иако бројот на пензионерите  тогаш не бил голем, ги имало педесетина, сепак формирањето на организацијата имало  и има големо значење, бидејќи преку неа се штитат интересите и правата на оваа категорија  граѓани. Сега во ЗП Неготино и Демир Капија, членуваат над 3 000 старосни, семејни  и инвалидски пензионери, како и инвалиди на трудот. Здружението поседува пензионерски  дом. Во трите пензионерски клуба Неготино, Криволак и &nbsp;Дисан, &nbsp;пензионерите  се среќаваат, комуницираат, се забавуваат и рекреираат.</p>
          <p>Во ЗП Неготино функционираат 12 ограноци и тоа 5  во Неготино и 7 во руралните средини, во селата. </p>
          <p>Посебно треба да се истакне постоењето на Клубот на  пензионерки &ldquo;Неготинијана&rdquo; во Неготино, со кој во целина е остварена целта за отворање  на клубот пензионерките и во него се дружат, се релаксираат, едуцираат, спортуваат,  се забавуваат и учествуваат во разни општествени и хуманитарни активности. Во организација  на клубот се реализирани и бројни излети и посети на културно-историски споменици  во сите краеви на нашата земја.</p>
          <p>За развојот и унапредувањето на културно-забавниот  живот во најголема мера придонесува и вокално-инструменталната група &ldquo;Распеани пензионери&rdquo;  има испеано многу песни и има реализирано голем број настапи во општината и Републиката.</p>
          <p>Здружението има добра соработка со локалната  самоуправа. </p>

...
<html xmlns="http://www.w3.org/1999/xhtml" lang="mk" xml:lang="mk"><!-- InstanceBegin template="/Templates/novo_selo.dwt.asp" codeOutsideHTMLIsLocked="false" -->
<head>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="heder">&nbsp;</td>
    <td class="heder" width="980"><div class="logo" onClick="window.location='../novo_selo/'">Здружение на пензионери <strong>Ново Село</strong></div></td>
    <td class="heder">&nbsp;</td>
  </tr>
  </table>
  <div class="meni">
  ...
  <tr>
    ...
    <td width="750"><table width="980" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="5"><img src="../images/meni_razdelnik.png" width="5" height="39" /></td>
        <td width="110" align="center"><a href="../novo_selo/programa.asp">Програма</a></td>
        <td width="5"><img src="../images/meni_razdelnik.png" width="5" height="39" /></td>
        <td width="150" align="center"><a href="../novo_selo/dokumenti.asp">Документи</a></td>-->
        <td width="5"><img src="../images/meni_razdelnik.png" width="5" height="39" /></td>
    ...
    <td width="50%">Надзорен одбор</td>
          ...
          <table width="100%" class="dijagram">
            <tr>
              ...
              <td width="25%">Изборна комисија </td>
              <td width="25%">Комисија за културно-забавен живот</td>
              <td width="25%">Комисија за спорт и рекреација</td>
              </tr>
            <tr>
              <td>Комисија за жалби и поплаки</td>
              <td>Верификациона комисија</td>
              <td>Кандидациона комисија</td>
              <td>12 ограноци</td>
            </tr>
          </table>
          <br />
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="bez_padding">
            <tr>
              <td width="33%" align="center"><img src="Stojan-Cvetanov-pretsedatel-na-ZP-Novo-Selo.jpg" alt="" width="110" height="150" /></td>
              <td width="1%" align="center">&nbsp;</td>
              </tr>
            <tr>
              <td align="center" valign="top"><strong><em>Стојан Цветанов</em></strong>, <br />
                Претседател на  ЗП Ново Село</td>
      ...
      <!--<p align="center"><img src="Sobranie.jpg" alt="" width="520" height="286" /><br />
          ...
          <ol>
            <li>Стојан Цветанов-претседател</li>
            <li>Владимир Мешев</li>
            <li>Атанас Пертемов</li>
            <li>Никола Калпачки</li>
            <li>Киро Велков</li>
            <li>Ванчо Јанушев</li>
            <li>Димитар Димитров</li>
            <li>Стоил Цветанов</li>
            <li>Стојан Китанов</li>
          </ol>
          <h2>НАДЗОРЕН ОДБОР</h2>
          <ol>
            <li>Ванчо Баџуков &ndash; претседател</li>
            <li>Сречко Мартинов</li>
            <li>Илија Ковачев</li>
          </ol>
          <h2>ПРЕТСЕДАТЕЛИ НА ОГРАНОЦИ          </h2>
          <ol>
            <li>Јовица Миросављевиќ, Ново Село</li>
            <li>Петра Стојанова, с. Сушица</li>
            <li>Ристо Глигоровски, с.  Зубово</li>
            <li>Христо Стопјанов, с. Колешино&nbsp;&nbsp;&nbsp; </li>
            <li>Лазар Трајанов, с. Борисово&nbsp;&nbsp;&nbsp;&nbsp; </li>
            <li>Димитар Димитров, с. Мокриево&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </li>
            <li>Петар Стојчев, с. Мокрино&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; - </li>
            <li>Атанас Јанков, с. Смолари </li>
            <li>Борис Аризанов, с. Дражево</li>
            <li>Кирил Стојчев, с. Старо  Коњарево</li>
            <li>Бошков Стојчев, с. Ново  Коњарево </li>
            <li>Стојан Китанов, с. Самоилово</li>
        </ol>
          <h2>&nbsp;</h2>

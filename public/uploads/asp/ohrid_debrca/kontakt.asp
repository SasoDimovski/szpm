...
%>
        ...
        <td valign="top" class="kelija_sodrzina"><!-- InstanceBeginEditable name="sodrzina" -->
          <h3>Здружение на пензионерите на „Охрид и Дебрца“</h3>
          <p>Ул. Димитар Влахов бр 46&nbsp; Охрид<br />
            Телефон 046 262 149<br />
            E-mail: <a href="mailto:zpohrid@hotmail.com">zpohrid@hotmail.com</a></p>

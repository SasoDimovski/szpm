...
%>
        ...
        <td valign="top" class="kelija_sodrzina"><!-- InstanceBeginEditable name="sodrzina" -->
          <p>Здружението на пензионери Струмица е формирано во  далечната 1953 година од група на ентузијасти пензионери од Струмица, со име  Општинско здружение на пензионери Струмица.</p>
          <p> Во 1969 година тогашниот Управениот одбор на здружението  на иницијатива на Марика Ѓорѓиева донесува одлука за изградба на Дом на  пензионери во Струмица, истата година е ставен камен темел на домот.</p>
          <p> Во октомври 1971 година Општинското здружение на  пензионери Струмица добива новоизграден дом на улица Ленинова бр.97 Струмица.</p>
          <p> Во декември 1998 година со одлука на Собранието  Општинското здружение на пензионери Струмица се преименува во Здружение на  пензионери Струмица.<br />
            Здружението на пензионери Струмица сега има 10.245 члена,  организирани во 26 ограноци.</p>
          <p>            На територијата на здружението на пензионери Струмица  функционираат 18 клубови за дневен престој на пензионери.</p>
          <p>Акти по кои работи ЗП Струмица:</p>
          <ul>
            <li>Статут</li>
            <li>Деловник за работа на Собранието</li>
            <li>Деловник за работа на Извршниот Одбор</li>
            <li>Правилник за еднократна парична помош</li>
            <li>Годишна Програма за работа</li>
        </ul>

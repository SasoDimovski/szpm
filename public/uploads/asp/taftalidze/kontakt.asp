...
%>
        ...
        <td valign="top" class="kelija_sodrzina"><!-- InstanceBeginEditable name="sodrzina" -->
          <h3>Здружение на пензионерите на „Тафталиџе ДДД“</h3>
          <p>ул. Иван Аговски бб<br />
            1000 Скопје<br />
            Телефон 30 79 683<br />
            Е-маил: <a href="mailto:zptaftaligeddd@yahoo.com">zptaftaligeddd@yahoo.com</a></p>

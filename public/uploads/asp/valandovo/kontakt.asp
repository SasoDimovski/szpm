...
%>
        ...
        <td valign="top" class="kelija_sodrzina"><!-- InstanceBeginEditable name="sodrzina" -->
          <h2>ЗДРУЖЕНИЕ НА  ПЕНЗИОНЕРИ &ndash;&nbsp;Валандово</h2>
          <p> Улицa; &bdquo;&nbsp;Маршал Тито&bdquo; бр. 42<br />
            Телефон: 034-381- 010<br />
            Меил:&nbsp;<a href="javascript:void(0);">zpvalandovo@yahoo.com</a></p>
<h3>&nbsp;</h3>

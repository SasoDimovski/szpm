    ...
    <td width="33%">Статутарна   комисија</td>
          ...
          <table width="100%" class="dijagram">
            <tr>
              ...
              <td width="33%">Комисија за екологија</td>
              </tr>
            <tr>
              <td>Комисија за доделување станови</td>
              <td>Комисија за наградување и признанија</td>
            </tr>
          </table>
          <br />
          <table width="50%" border="0" cellspacing="0" cellpadding="0" class="bez_padding">
            <tr>
              <td width="50%" align="center"><img src="Gorica-Mihajlova-sekretar-na-IO.jpg" alt="" width="110" height="160" /></td>
              <td align="center"></td>
              <td width="50%" align="center"><img src="Zdravko-Boshnachki-predsedavac.jpg" alt="" width="110" height="160" /></td>
              <td align="center"></td>
              <td width="50%" align="center"><img src="Mile-Shuntov-sekretar.jpg" alt="" width="110" height="160" /></td>
              </tr>
            <tr>
              <td align="center" valign="top">Горица Михајлова  - претседател и делегат во СЗПМ</td>
              <td align="center" valign="top"></td>
              <td align="center" valign="top">Здравко Бошначки - председавач</td>
              <td align="center" valign="top"></td>
              <td align="center" valign="top">Миле Шунтов - секретар</td>
              </tr>
      </table>
      <!--<p align="center"><img src="Sobranie.jpg" alt="" width="520" height="286" /><br />
            <strong><em>Собрание на Здружението</em></strong></p>-->
          
          <h2 align="">Собрание</h2>
          <ol>
              <li>Здравко&nbsp; Бошначки &ndash;  председавач</li>
              <li>Миле Шунтов</li>
              <li>Горица Михајлова</li>
              <li>Бончо Јанчев</li>
              <li>Лена Органџиева</li>
              <li>Бранко Ласков</li>
              <li>Живко Ѓорѓиев</li>
              <li>Ѓорге илиев</li>
              <li>Зуица Илиева</li>
              <li>Васе Пиндеров</li>
              <li>Љубинка Павлова</li>
              <li>Васе Аџиев</li>
              <li>Никола Џонов</li>
              <li>Стојан Стојанов</li>
              <li>Аница Ѓеоргиевска</li>
              <li>Илија Давчев</li>
              <li>Илија Мицев</li>
              <li>Драги Атанасов</li>
              <li>Каме Јанев</li>
              <li>Павлина Филова</li>
              <li>Алим Османов<!--
<p align="center"><img src="Izvrshen-odbor.jpg" alt="" width="520" height="292" /><br />
...
-->          </li>
          ...
          <h2>   Статутарна  комисија              </h2>
              ...
              <ol>
                  <li>Соња Арнаудова</li>
                  <li>Васил Тошев</li>
                  <li>Валентина Попова          </li>
              </ol>
          ...
          <ol>
              <li>&nbsp;Миле&nbsp; Боев</li>
                ...
                <li>Лена&nbsp; Органџиева</li>
                <li>Васе Аџиев</li>
                <li>Трајче Невеселов</li>
          </ol>
          <h2>Комисија  за културно-забавен  живот</h2>
          <ol>
              <li>Здравко Бошначки</li>
                <li>Аница Ѓеоргиевска</li>
                <li>Бранко Ласков          </li>
          </ol>
          <h2>Комисија  за станбени прашања</h2>
          <ol>
              <li>Бончо Јанчев</li>
                <li>Лена Оргаџиева</li>
                <li>Драги Атанасов        </li>
          </ol>
